...
class Match(val home: Club, val away: Club):
  ...
  override def toString =
    if this.isGoalless
      then this.home.name + " vs. " + this.away.name + " at " + this.location + ": tied at nil-nil"
    else if this.isTied
      then this.home.name + " vs. " + this.away.name + " at " + this.location + ": tied at " + this.homeGoals +"-all"
    else if this.isHomeWin
      then this.home.name + " vs. " + this.away.name + " at " + this.location + ": " + this.homeGoals + "-" + this.awayGoals + " to " + this.home.name
    else
      this.home.name + " vs. " + this.away.name + " at " + this.location + ": " + this.awayGoals + "-" + this.homeGoals + " to " + this.away.name
